...
class Channel
{
	...
	//Various methods
		...
		void numFluxHLL_K(double q1m, double q1p, double q2m, double q2p, double *flux, bool Pm, bool Pp, int loc);    // loc means L, loc+1 means R  
...
class Junction3
{
	public:
		...
		double findOmega(double Astar, double Ak, double D, double At, double Ts, bool Ps, bool Pk);
		double getarea(double alpha, double old_alpha, double beta, double A_temp_past, double Q_temp_past, double Q0_past, double v2_past, double v0_past, double v0, double v1, double v2, double Q0, 
						double Q1, double Q2,double A0, double A1, double A2, double dt);
		double RecursiveArea(double leftA, double left_diff, double rightA, double right_diff, double rhs);
		double get_diff(double A, double rhs);
		double getsigma(double alpha, double old_alpha, double beta, double A_temp_past, double Q_temp_past, double Q0_past, double v2_past, double v0_past, double v0, 
						double v1, double v2, double Q0, double Q1, double Q2,double A0, double A1, double A2, double dt);
		double getalpha(double old_alpha, double left_alpha, double left_sigma, double right_alpha, double right_sigma, double alpha, 
						double beta, double A_temp_past, double Q_temp_past, double Q0_past, double v2_past, double v0_past, double v0, double v1, double v2, 
						double Q0, double Q1, double Q2,double A0, double A1, double A2, double dt);
};
